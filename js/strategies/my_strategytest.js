// my_strategytest.js — Generated by NEXUS Strategy Builder
// Custom strategy

export const MyStrategytestStrategy = {
    ...
    checkEntry(candles, rsiState, h4Candles) {
        ...
        // ── BUY SIGNAL ──
        const buySignal = true;
        if (buySignal) {
            return { type: 'BUY', label: 'My Strategy Buy',
                     slMultiplier: 1.5, tpMultiplier: 2 };
        }

        // ── SELL SIGNAL ──
        const sellSignal = true;
        if (sellSignal) {
            return { type: 'SELL', label: 'My Strategy Sell',
                     slMultiplier: 1.5, tpMultiplier: 2 };
        }
